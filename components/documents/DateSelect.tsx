  ...
  return (
    <div>
      ...
      <fieldset className="mt-4">
        <input
          className="block rounded-md border-0 py-1.5 text-slate-900 shadow-xs ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
          value={pdfData[name as keyof typeof pdfData]}
