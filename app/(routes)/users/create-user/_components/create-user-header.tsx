      ...
      <div className="min-w-0 flex-1">
        <nav aria-label="Breadcrumb" className="flex">
          <ol role="list" className="flex items-center space-x-4">
            <li>
              <div className="flex">
                <Link href="/users" className="text-sm font-medium text-gray-500 hover:text-gray-700">
                  Usuarios
                </Link>
              </div>
            </li>
            <li>
              <div className="flex items-center">
                ...
                <Link href="/users/create-user" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                  Crear Usuario
                </Link>
              </div>
            </li>
