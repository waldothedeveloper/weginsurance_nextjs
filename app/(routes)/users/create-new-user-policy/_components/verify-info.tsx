...
export const VerifyInfo = () => {
  const { steps } = useCreateUserPolicy();

  console.log("steps in verify-info: ", JSON.stringify(steps, null, 2));
          ...
          <div className="px-4 py-5 sm:px-6">
            <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              ...
              <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-sm text-gray-900">{step.data.ssn}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500">Edad</dt>
                <dd className="mt-1 text-sm text-gray-900">{step.data.age}</dd>
              </div>
              {/* Divider start */}
              <div className="sm:col-span-2">
                <div className="relative">
              ...
              <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-sm text-gray-900">{step.data.city}</dd>
              </div>
              <div className="sm:col-span-1">
